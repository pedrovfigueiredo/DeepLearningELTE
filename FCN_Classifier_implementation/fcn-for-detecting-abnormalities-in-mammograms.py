...
def get_training_data(what=10):
    if what == 10:
        train_path_10 = os.path.join("input", "ddsm-mammography","training10_0.tfrecords")
        train_path_11 = os.path.join("input", "ddsm-mammography","training10_1.tfrecords")
        train_path_12 = os.path.join("input", "ddsm-mammography", "training10_2.tfrecords")
        train_path_13 = os.path.join("input", "ddsm-mammography", "training10_3.tfrecords")
...
def get_test_data(what=10):
    test_files = os.path.join("input", "ddsm-mammography", "training10_4.tfrecords")
